...
In a somewhat parallel manner to jQuery, server-first frameworks such as Django and Ruby on Rails were becoming popular and taking over the hearts of many back-end developmers, as they could just continue using the languages they already know and love. 

dynamic features were introduced such as making your HTML life easier with templates, or requesting server-side data with API calls. Among others, Django and Ruby on Rails became extremely popular 
